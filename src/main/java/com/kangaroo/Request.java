...
public class Request implements java.io.Serializable {
    ...
    public Request(String path, byte[] payload) {
        this.path = path;
        this.payload = payload;
    }


    public Request(String path, byte[] payload, Header... value) {
        this.path = path;
        this.payload = payload;
...
//		this.attachments.addAll(attachments);
    ...
    public List<Attachment> getAttachment() {
        Attachment[] attachments = (Attachment[]) getAttribute(Request.ATTCHMENT_FIELD);
        if (attachments == null) {
