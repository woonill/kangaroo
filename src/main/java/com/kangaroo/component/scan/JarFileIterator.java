...
final class JarFileIterator implements ResourceIterator {
     ...
     * @throws IOException
     */
    public JarFileIterator(File file, Predicate<String> filter) throws IOException {
     ...
     * @throws IOException
     */
    public JarFileIterator(InputStream is, Predicate<String> filter) throws IOException {
        this.filter = filter;
    ...
    private void setNext() {
        ...
        try {
            ...
            } while (next != null && (next.isDirectory() || (filter == null || !filter.test(next.getName()))));
