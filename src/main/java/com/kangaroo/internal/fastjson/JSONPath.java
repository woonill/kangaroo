...
public class JSONPath implements JSONAware {
    ...
    private com.kangaroo.internal.fastjson.parser.ParserConfig parserConfig;

    public JSONPath(String path){
        this(path, com.kangaroo.internal.fastjson.serializer.SerializeConfig.getGlobalInstance(), com.kangaroo.internal.fastjson.parser.ParserConfig.getGlobalInstance());
    }

    public JSONPath(String path, com.kangaroo.internal.fastjson.serializer.SerializeConfig serializeConfig, com.kangaroo.internal.fastjson.parser.ParserConfig parserConfig){
...
//            
            ...
            if (currentObject == null) {
                ...
                if (nextSegement instanceof PropertySegement) {
                    com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer beanDeserializer = null;
                    Class<?> fieldClass = null;
                    if (segment instanceof PropertySegement) {
                        String propertyName = ((PropertySegement) segment).propertyName;
                        Class<?> parentClass = parentObject.getClass();
                        com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer parentBeanDeserializer = getJavaBeanDeserializer(parentClass);
                        if (parentBeanDeserializer != null) {
                            com.kangaroo.internal.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = parentBeanDeserializer.getFieldDeserializer(propertyName);
                    ...
                    newObj = new com.kangaroo.internal.fastjson.JSONArray();
                }
    ...
    public static Map<String, Object> paths(Object javaObject) {
        return paths(javaObject, com.kangaroo.internal.fastjson.serializer.SerializeConfig.globalInstance);
    }
    
    public static Map<String, Object> paths(Object javaObject, com.kangaroo.internal.fastjson.serializer.SerializeConfig config) {
    ...
    private static void paths(Map<Object, String> values, Map<String, Object> paths, String parent, Object javaObject, com.kangaroo.internal.fastjson.serializer.SerializeConfig config) {
        if (javaObject == null) {
            return;
        }
        ...
        if (com.kangaroo.internal.fastjson.parser.ParserConfig.isPrimitive2(clazz) || clazz.isEnum()) {
            return;
        }
        ...
        if (serializer instanceof com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer) {
            com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer javaBeanSerializer = (com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer) serializer;
    ...
    @SuppressWarnings("rawtypes")
    private static void paths(Map<Object, String> paths, String parent, Object javaObject, com.kangaroo.internal.fastjson.serializer.SerializeConfig config) {
        if (javaObject == null) {
            return;
        }
    ...
    static class JSONPathParser {
        ...
        Object parseArrayAccessFilter(boolean acceptBracket) {
            ...
            if (predicateFlag || com.kangaroo.internal.fastjson.util.IOUtils.firstIdentifier(ch)) {
                String propertyName = readName();
                ...
                if (op == Operator.IN || op == Operator.NOT_IN) {
                    ...
                    List<Object> valueList = new com.kangaroo.internal.fastjson.JSONArray();
                    {
        ...
        String readName() {
            ...
            if (ch != '\\' && !com.kangaroo.internal.fastjson.util.IOUtils.firstIdentifier(ch)) {
            ...
            while (!isEOF()) {
                ...
                boolean identifierFlag = com.kangaroo.internal.fastjson.util.IOUtils.isIdent(ch);
                if (!identifierFlag) {
                    break;
                }
                buf.append(ch);
            ...
            if (isEOF() && com.kangaroo.internal.fastjson.util.IOUtils.isIdent(ch)) {
                buf.append(ch);
            }
        ...
        Segement buildArraySegement(String indexText) {
            ...
            if (commaIndex == -1 && colonIndex == -1) {
                if (com.kangaroo.internal.fastjson.util.TypeUtils.isNumber(indexText)) {
                    try {
    ...
    static class PropertySegement implements Segement {
        ...
        public PropertySegement(String propertyName, boolean deep){
            ...
            this.propertyNameHash = com.kangaroo.internal.fastjson.util.TypeUtils.fnv1a_64(propertyName);
            this.deep = deep;
        }
    ...
    static class MultiPropertySegement implements Segement {
        ...
        public MultiPropertySegement(String[] propertyNames){
            ...
            for (int i = 0; i < propertyNamesHash.length; i++) {
                propertyNamesHash[i] = com.kangaroo.internal.fastjson.util.TypeUtils.fnv1a_64(propertyNames[i]);
            }
        }
    ...
    static class DoubleOpSegement implements Filter {
        ...
        public DoubleOpSegement(String propertyName, double value, Operator op){
            ...
            this.value = value;
            this.op = op;
            propertyNameHash = com.kangaroo.internal.fastjson.util.TypeUtils.fnv1a_64(propertyName);
        }
    ...
    static public class FilterSegement implements Segement {
        ...
        public Object eval(JSONPath path, Object rootObject, Object currentObject) {
            ...
            List<Object> items = new com.kangaroo.internal.fastjson.JSONArray();
    ...
    protected Collection<Object> getPropertyValues(final Object currentObject) {
        ...
        com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer beanSerializer = getJavaBeanSerializer(currentClass);
    ...
    protected Object getPropertyValue(Object currentObject, String propertyName, long propertyNameHash) {
        ...
        if (currentObject instanceof List) {
            ...
            List<Object> fieldValues = new com.kangaroo.internal.fastjson.JSONArray(list.size());
    ...
    protected void deepScan(final Object currentObject, final String propertyName, List<Object> results) {
        ...
        if (beanSerializer != null) {
            try {
                com.kangaroo.internal.fastjson.serializer.FieldSerializer fieldDeser = beanSerializer.getFieldSerializer(propertyName);
                if (fieldDeser != null) {
                    try {
    ...
    protected void deepSet(final Object currentObject, final String propertyName, long propertyNameHash, Object value) {
        ...
        com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer beanDeserializer = getJavaBeanDeserializer(currentClass);
        if (beanDeserializer != null) {
            try {
                com.kangaroo.internal.fastjson.parser.deserializer.FieldDeserializer fieldDeser = beanDeserializer.getFieldDeserializer(propertyName);
                if (fieldDeser != null) {
    ...
    protected boolean setPropertyValue(Object parent, String name, long propertyNameHash, Object value) {
        ...
        com.kangaroo.internal.fastjson.parser.deserializer.ObjectDeserializer derializer = parserConfig.getDeserializer(parent.getClass());

        com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer beanDerializer = null;
        if (derializer instanceof com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer) {
            beanDerializer = (com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer) derializer;
        }

        if (beanDerializer != null) {
            com.kangaroo.internal.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = beanDerializer.getFieldDeserializer(propertyNameHash);
    ...
    protected boolean removePropertyValue(Object parent, String name) {
        ...
        if (beanDerializer != null) {
            com.kangaroo.internal.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = beanDerializer.getFieldDeserializer(name);
            if (fieldDeserializer == null) {
                return false;
            }
    ...
    protected com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer getJavaBeanSerializer(final Class<?> currentClass) {
        com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer beanSerializer = null;
        {
            com.kangaroo.internal.fastjson.serializer.ObjectSerializer serializer = serializeConfig.getObjectWriter(currentClass);
            if (serializer instanceof com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer) {
                beanSerializer = (com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer) serializer;
            }
        }
        return beanSerializer;
    }

    protected com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer getJavaBeanDeserializer(final Class<?> currentClass) {
        com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer beanDeserializer = null;
        {
            com.kangaroo.internal.fastjson.parser.deserializer.ObjectDeserializer deserializer = parserConfig.getDeserializer(currentClass);
            if (deserializer instanceof com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer) {
                beanDeserializer = (com.kangaroo.internal.fastjson.parser.deserializer.JavaBeanDeserializer) deserializer;
            }
        }
    ...
    int evalSize(Object currentObject) {
        ...
        com.kangaroo.internal.fastjson.serializer.JavaBeanSerializer beanSerializer = getJavaBeanSerializer(currentObject.getClass());
