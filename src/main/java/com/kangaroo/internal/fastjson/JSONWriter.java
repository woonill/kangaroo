...
public class JSONWriter implements Closeable, Flushable {
    ...
    private com.kangaroo.internal.fastjson.serializer.SerializeWriter writer;

    private com.kangaroo.internal.fastjson.serializer.JSONSerializer serializer;

    private JSONStreamContext context;

    public JSONWriter(Writer out){
        writer = new com.kangaroo.internal.fastjson.serializer.SerializeWriter(out);
        serializer = new com.kangaroo.internal.fastjson.serializer.JSONSerializer(writer);
    }

    public void config(com.kangaroo.internal.fastjson.serializer.SerializerFeature feature, boolean state) {
