...
public interface JSONLexer {
    ...
    boolean isEnabled(com.kangaroo.internal.fastjson.parser.Feature feature);

    void config(com.kangaroo.internal.fastjson.parser.Feature feature, boolean state);
