 ...
 */
public abstract class JSONLexerBase implements com.kangaroo.internal.fastjson.parser.JSONLexer, Closeable {
    ...
    protected TimeZone                       timeZone           = com.kangaroo.internal.fastjson.JSON.defaultTimeZone;
    protected Locale                         locale             = com.kangaroo.internal.fastjson.JSON.defaultLocale;
    ...
    public JSONLexerBase(int features){
        ...
        if ((features & com.kangaroo.internal.fastjson.parser.Feature.InitStringFieldAsEmpty.mask) != 0) {
            stringDefaultValue = "";
        }
    ...
    public final void nextToken() {
        ...
        for (;;) {
            ...
            switch (ch) {
                case '\'':
                    if (!isEnabled(com.kangaroo.internal.fastjson.parser.Feature.AllowSingleQuotes)) {
    ...
    public final void nextToken(int expect) {
        ...
        for (;;) {
            switch (expect) {
                case com.kangaroo.internal.fastjson.parser.JSONToken.LBRACE:
                    if (ch == '{') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.LBRACE;
                        next();
                        return;
                    }
                    if (ch == '[') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.LBRACKET;
                        next();
                        return;
                    }
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.COMMA:
                    if (ch == ',') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.COMMA;
                        next();
                        return;
                    }

                    if (ch == '}') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.RBRACE;
                        next();
                        return;
                    }

                    if (ch == ']') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.RBRACKET;
                        next();
                        return;
                    }

                    if (ch == EOI) {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.EOF;
                        return;
                    }
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_INT:
                    if (ch >= '0' && ch <= '9') {
                        pos = bp;
                        scanNumber();
                        return;
                    ...
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_STRING:
                    if (ch == '"') {
                        pos = bp;
                        scanString();
                        return;
                    ...
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.LBRACKET:
                    if (ch == '[') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.LBRACKET;
                        next();
                        return;
                    ...
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.RBRACKET:
                    if (ch == ']') {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.RBRACKET;
                        next();
                        return;
                    }
                case com.kangaroo.internal.fastjson.parser.JSONToken.EOF:
                    if (ch == EOI) {
                        token = com.kangaroo.internal.fastjson.parser.JSONToken.EOF;
                        return;
                    }
                    break;
                case com.kangaroo.internal.fastjson.parser.JSONToken.IDENTIFIER:
                    nextIdent();
                    return;
                default:
                    break;
    ...
    public final String tokenName() {
        return com.kangaroo.internal.fastjson.parser.JSONToken.name(token);
    }
    ...
    public void config(com.kangaroo.internal.fastjson.parser.Feature feature, boolean state) {
        features = com.kangaroo.internal.fastjson.parser.Feature.config(features, feature, state);
    ...
    public final boolean isEnabled(com.kangaroo.internal.fastjson.parser.Feature feature) {
    ...
    public final String scanSymbol(final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable) {
        skipWhitespace();
        ...
        if (!isEnabled(com.kangaroo.internal.fastjson.parser.Feature.AllowUnQuotedFieldNames)) {
            throw new JSONException("syntax error");
        }
    ...
    public final String scanSymbol(final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable, final char quote) {
        int hash = 0;
    ...
    public final String scanSymbolUnQuoted(final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable) {
        if (token == com.kangaroo.internal.fastjson.parser.JSONToken.ERROR && pos == 0 && bp == 1) {
            bp = 0; // adjust
        }
        final boolean[] firstIdentifierFlags = com.kangaroo.internal.fastjson.util.IOUtils.firstIdentifierFlags;
        final char first = ch;
        ...
        final boolean[] identifierFlags = com.kangaroo.internal.fastjson.util.IOUtils.identifierFlags;
        ...
        this.ch = charAt(bp);
        token = com.kangaroo.internal.fastjson.parser.JSONToken.IDENTIFIER;
    ...
    public final void scanString() {
        ...
        token = com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_STRING;
        this.ch = next();
    }
    ...
    protected final static char[] typeFieldName = ("\"" + com.kangaroo.internal.fastjson.JSON.DEFAULT_TYPE_KEY + "\":\"").toCharArray();
    ...
    public final boolean matchField(char[] fieldName) {
        ...
        if (ch == '{') {
            ...
            bp += 3;
            ch = charAt(bp);
            token = com.kangaroo.internal.fastjson.parser.JSONToken.SET;
        } else {
            nextToken();
        }
    ...
    public abstract String addSymbol(int offset, int len, int hash, final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable);
    ...
    public Enum<?> scanEnum(Class<?> enumClass, final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable, char serperator) {
    ...
    public String scanSymbolWithSeperator(final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable, char serperator) {
        matchStat = UNKNOWN;
...
//            value = new BigInteger(chars, )
    ...
    public Date scanFieldDate(char[] fieldName) {
        ...
        if (chLocal == '"'){
            ...
            com.kangaroo.internal.fastjson.parser.JSONScanner dateLexer = new com.kangaroo.internal.fastjson.parser.JSONScanner(stringVal);
            try {
    ...
    public final void scanTrue() {
        ...
        if (ch == ' ' || ch == ',' || ch == '}' || ch == ']' || ch == '\n' || ch == '\r' || ch == '\t' || ch == EOI
                || ch == '\f' || ch == '\b' || ch == ':' || ch == '/') {
            token = com.kangaroo.internal.fastjson.parser.JSONToken.TRUE;
        } else {
    ...
    public final void scanNullOrNew() {
        ...
        if (ch == 'u') {
            ...
            if (ch == ' ' || ch == ',' || ch == '}' || ch == ']' || ch == '\n' || ch == '\r' || ch == '\t' || ch == EOI
                    || ch == '\f' || ch == '\b') {
                token = com.kangaroo.internal.fastjson.parser.JSONToken.NULL;
            } else {
        ...
        if (ch == ' ' || ch == ',' || ch == '}' || ch == ']' || ch == '\n' || ch == '\r' || ch == '\t' || ch == EOI
                || ch == '\f' || ch == '\b') {
            token = com.kangaroo.internal.fastjson.parser.JSONToken.NEW;
        } else {
    ...
    public final void scanFalse() {
        ...
        if (ch == ' ' || ch == ',' || ch == '}' || ch == ']' || ch == '\n' || ch == '\r' || ch == '\t' || ch == EOI
                || ch == '\f' || ch == '\b' || ch == ':' || ch == '/') {
            token = com.kangaroo.internal.fastjson.parser.JSONToken.FALSE;
        } else {
    ...
    public final void scanIdent() {
        ...
        for (;;) {
            ...
            if ("null".equalsIgnoreCase(ident)) {
                ...
                token = com.kangaroo.internal.fastjson.parser.JSONToken.UNDEFINED;
            } else if ("Set".equals(ident)) {
                token = com.kangaroo.internal.fastjson.parser.JSONToken.SET;
            } else if ("TreeSet".equals(ident)) {
                token = com.kangaroo.internal.fastjson.parser.JSONToken.TREE_SET;
            } else {
                token = com.kangaroo.internal.fastjson.parser.JSONToken.IDENTIFIER;
            }
            return;
    ...
    public final void scanHex() {
        ...
        token = com.kangaroo.internal.fastjson.parser.JSONToken.HEX;
    }
    ...
    public final void scanNumber() {
        ...
        if (isDouble) {
            token = com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_FLOAT;
        } else {
            token = com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_INT;
        }
    }
     ...
     * @return
     */
    public String[] scanFieldStringArray(char[] fieldName, int argTypesCount, com.kangaroo.internal.fastjson.parser.SymbolTable typeSymbolTable) {
