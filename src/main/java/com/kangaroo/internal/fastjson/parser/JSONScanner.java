...
public final class JSONScanner extends JSONLexerBase {
    ...
    public JSONScanner(String input){
        this(input, com.kangaroo.internal.fastjson.JSON.DEFAULT_PARSER_FEATURE);
    }
    ...
    public JSONScanner(char[] input, int inputLength){
        this(input, inputLength, com.kangaroo.internal.fastjson.JSON.DEFAULT_PARSER_FEATURE);
    }
    ...
    public final String addSymbol(int offset, int len, int hash, final com.kangaroo.internal.fastjson.parser.SymbolTable symbolTable) {
        return symbolTable.addSymbol(text, offset, len, hash);
    }

    public byte[] bytesValue() {
        if (token == com.kangaroo.internal.fastjson.parser.JSONToken.HEX) {
        ...
        return com.kangaroo.internal.fastjson.util.IOUtils.decodeBase64(text, np + 1, sp);
    }
    ...
    public final String subString(int offset, int count) {
        if (com.kangaroo.internal.fastjson.util.ASMUtils.IS_ANDROID) {
    ...
    public final char[] sub_chars(int offset, int count) {
        if (com.kangaroo.internal.fastjson.util.ASMUtils.IS_ANDROID && count < sbuf.length) {
            text.getChars(offset, offset + count, sbuf, 0);
            return sbuf;
        } else {
            char[] chars = new char[count];
    ...
    private boolean scanISO8601DateIfMatch(boolean strict, int rest) {
        ...
        if ((!strict) && rest > 13) {
            ...
            if (c0 == '/' && c1 == 'D' && c2 == 'a' && c3 == 't' && c4 == 'e' && c5 == '(' && c_r0 == '/'
                ...
                token = com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_ISO8601_DATE;
                return true;
            }
        }
