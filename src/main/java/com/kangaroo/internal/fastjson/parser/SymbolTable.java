...
public class SymbolTable {
    ...
    public SymbolTable(int tableSize){
        ...
        this.addSymbol(com.kangaroo.internal.fastjson.JSON.DEFAULT_TYPE_KEY, 0, com.kangaroo.internal.fastjson.JSON.DEFAULT_TYPE_KEY.length(), com.kangaroo.internal.fastjson.JSON.DEFAULT_TYPE_KEY.hashCode());
    }
