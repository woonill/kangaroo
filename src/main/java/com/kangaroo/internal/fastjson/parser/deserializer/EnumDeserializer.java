...
public class EnumDeserializer implements ObjectDeserializer {
    ...
    public EnumDeserializer(Class<?> enumClass){
        ...
        for (int i = 0; i < ordinalEnums.length; ++i) {
            ...
            com.kangaroo.internal.fastjson.annotation.JSONField jsonField = null;
            try {
                Field field = enumClass.getField(name);
                jsonField = field.getAnnotation(com.kangaroo.internal.fastjson.annotation.JSONField.class);
                if (jsonField != null) {
    ...
    public <T> T deserialze(com.kangaroo.internal.fastjson.parser.DefaultJSONParser parser, Type type, Object fieldName) {
        try {
            ...
            if (token == com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_INT) {
            ...
            } else if (token == com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_STRING) {
            ...
            } else if (token == com.kangaroo.internal.fastjson.parser.JSONToken.NULL) {
                value = null;
                lexer.nextToken(com.kangaroo.internal.fastjson.parser.JSONToken.COMMA);
