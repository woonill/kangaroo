...
public abstract class FieldDeserializer {
    ...
    public final com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo;

    protected final Class<?>  clazz;
    
    protected com.kangaroo.internal.fastjson.serializer.BeanContext beanContext;

    public FieldDeserializer(Class<?> clazz, com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo){
        this.clazz = clazz;
        this.fieldInfo = fieldInfo;
    }
    
    public abstract void parseField(com.kangaroo.internal.fastjson.parser.DefaultJSONParser parser, Object object, Type objectType,
