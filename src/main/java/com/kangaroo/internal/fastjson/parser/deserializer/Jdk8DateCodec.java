...
import com.kangaroo.internal.fastjson.serializer.SerializeWriter;

public class Jdk8DateCodec extends ContextObjectDeserializer implements com.kangaroo.internal.fastjson.serializer.ObjectSerializer, com.kangaroo.internal.fastjson.serializer.ContextObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(com.kangaroo.internal.fastjson.parser.DefaultJSONParser parser, Type type, Object fieldName, String format, int feature) {
        ...
        if (lexer.token() == com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_STRING) {
            ...
            if (type == LocalDateTime.class) {
                return (T) LocalDateTime.ofInstant(Instant.ofEpochMilli(millis), com.kangaroo.internal.fastjson.JSON.defaultTimeZone.toZoneId());
            }
            if (type == LocalDate.class) {
                return (T) LocalDateTime.ofInstant(Instant.ofEpochMilli(millis), com.kangaroo.internal.fastjson.JSON.defaultTimeZone.toZoneId()).toLocalDate();
            }
            if (type == LocalTime.class) {
                return (T) LocalDateTime.ofInstant(Instant.ofEpochMilli(millis), com.kangaroo.internal.fastjson.JSON.defaultTimeZone.toZoneId()).toLocalTime();
            }
    ...
    public int getFastMatchToken() {
        return com.kangaroo.internal.fastjson.parser.JSONToken.LITERAL_STRING;
    }
    ...
    public void write(com.kangaroo.internal.fastjson.serializer.JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (object == null) {
            ...
            if (fieldType == LocalDateTime.class) {
                final int mask = com.kangaroo.internal.fastjson.serializer.SerializerFeature.UseISO8601DateFormat.getMask();
                LocalDateTime dateTime = (LocalDateTime) object;
                String format = serializer.getDateFormatPattern();

                if (format == null && (features & mask) != 0 || serializer.isEnabled(com.kangaroo.internal.fastjson.serializer.SerializerFeature.UseISO8601DateFormat)) {
                ...
                if (dateTime.getNano() == 0 || format != null) {
                    ...
                    if (format == null) {
                        format = com.kangaroo.internal.fastjson.JSON.DEFFAULT_DATE_FORMAT;
                    }
                    write(out, dateTime, format);
                } else if (out.isEnabled(com.kangaroo.internal.fastjson.serializer.SerializerFeature.WriteDateUseDateFormat)) {
                    //使用固定格式转化时间
                    write(out, dateTime, com.kangaroo.internal.fastjson.JSON.DEFFAULT_DATE_FORMAT);
                } else {
                    out.writeLong(dateTime.atZone(com.kangaroo.internal.fastjson.JSON.defaultTimeZone.toZoneId()).toInstant().toEpochMilli());
                }
            } else {
    ...
    public void write(com.kangaroo.internal.fastjson.serializer.JSONSerializer serializer, Object object, com.kangaroo.internal.fastjson.serializer.BeanContext context) throws IOException {
        com.kangaroo.internal.fastjson.serializer.SerializeWriter out = serializer.out;
