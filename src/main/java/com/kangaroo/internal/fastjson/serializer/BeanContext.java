...
public final class BeanContext {
    ...
    private final com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo;
    private final String format;

    public BeanContext(Class<?> beanClass, com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo){
