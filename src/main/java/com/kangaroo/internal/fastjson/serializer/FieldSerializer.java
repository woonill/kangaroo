...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    protected com.kangaroo.internal.fastjson.serializer.BeanContext fieldContext;
    ...
    public FieldSerializer(Class<?> beanType, FieldInfo fieldInfo) {
        ...
        this.fieldContext = new com.kangaroo.internal.fastjson.serializer.BeanContext(beanType, fieldInfo);
    ...
    public void writePrefix(com.kangaroo.internal.fastjson.serializer.JSONSerializer serializer) throws IOException {
    ...
    public void writeValue(com.kangaroo.internal.fastjson.serializer.JSONSerializer serializer, Object propertyValue) throws Exception {
        if (runtimeInfo == null) {
            ...
            if (fieldAnnotation != null && fieldAnnotation.serializeUsing() != Void.class) {
                ...
                if (format != null) {
                    if (runtimeFieldClass == double.class || runtimeFieldClass == Double.class) {
                        ...
                        fieldSerializer = new com.kangaroo.internal.fastjson.serializer.FloatCodec(format);
                    }
                }
        ...
        if (format != null && !(valueSerializer instanceof DoubleSerializer || valueSerializer instanceof com.kangaroo.internal.fastjson.serializer.FloatCodec)) {
        ...
        if (fieldInfo.unwrapped) {
            ...
            if (valueSerializer instanceof com.kangaroo.internal.fastjson.serializer.MapSerializer) {
                com.kangaroo.internal.fastjson.serializer.MapSerializer mapSerializer = (com.kangaroo.internal.fastjson.serializer.MapSerializer) valueSerializer;
