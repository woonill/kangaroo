...
import com.kangaroo.internal.fastjson.util.IOUtils;
...
public class JSONSerializer extends SerializeFilterable {
    ...
    protected IdentityHashMap<Object, com.kangaroo.internal.fastjson.serializer.SerialContext> references  = null;
    protected com.kangaroo.internal.fastjson.serializer.SerialContext context;
    ...
    public com.kangaroo.internal.fastjson.serializer.SerialContext getContext() {
        return context;
    }

    public void setContext(com.kangaroo.internal.fastjson.serializer.SerialContext context) {
        this.context = context;
    }

    public void setContext(com.kangaroo.internal.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features) {
        this.setContext(parent, object, fieldName, features, 0);
    }

    public void setContext(com.kangaroo.internal.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features, int fieldFeatures) {
        if (out.disableCircularReferenceDetect) {
            return;
        }

        this.context = new com.kangaroo.internal.fastjson.serializer.SerialContext(parent, object, fieldName, features, fieldFeatures);
        if (references == null) {
            references = new IdentityHashMap<Object, com.kangaroo.internal.fastjson.serializer.SerialContext>();
        }
    ...
    public boolean containsReference(Object value) {
        ...
        com.kangaroo.internal.fastjson.serializer.SerialContext refContext = references.get(value);
        if (refContext == null) {
            return false;
        }
    ...
    public void writeReference(Object object) {
        com.kangaroo.internal.fastjson.serializer.SerialContext context = this.context;
        ...
        com.kangaroo.internal.fastjson.serializer.SerialContext parentContext = context.parent;
        ...
        com.kangaroo.internal.fastjson.serializer.SerialContext rootContext = context;
        for (;;) {
    ...
    public final void write(String text) {
        com.kangaroo.internal.fastjson.serializer.StringCodec.instance.write(this, text);
    }
