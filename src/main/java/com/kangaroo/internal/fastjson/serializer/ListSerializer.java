...
public final class ListSerializer implements ObjectSerializer {
    ...
    public final void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType, int features)
        ...
        if (writeClassName) {
            elementType = com.kangaroo.internal.fastjson.util.TypeUtils.getCollectionItemType(fieldType);
        }
                ...
                for (Object item : list) {
                    ...
                    if (item != null) {
                        if (serializer.containsReference(item)) {
                            ...
                            com.kangaroo.internal.fastjson.serializer.SerialContext itemContext = new com.kangaroo.internal.fastjson.serializer.SerialContext(context, object, fieldName, 0, 0);
