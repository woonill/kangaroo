    ...
    public void write(JSONSerializer serializer
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                ...
                {
                    List<com.kangaroo.internal.fastjson.serializer.NameFilter> nameFilters = serializer.nameFilters;
                ...
                {
                    List<com.kangaroo.internal.fastjson.serializer.NameFilter> nameFilters = this.nameFilters;
                    if (nameFilters != null && nameFilters.size() > 0) {
                        if (entryKey == null || entryKey instanceof String) {
                            entryKey = this.processKey(serializer, object, (String) entryKey, value);
                        } else if (entryKey.getClass().isPrimitive() || entryKey instanceof Number) {
