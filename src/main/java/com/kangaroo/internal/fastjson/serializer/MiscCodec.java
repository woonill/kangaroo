...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    static {
        FILE_RELATIVE_PATH_SUPPORT = "true".equals(com.kangaroo.internal.fastjson.util.IOUtils.getStringProperty("fastjson.deserializer.fileRelativePathSupport"));
    }
    ...
    public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (objClass == SimpleDateFormat.class) {
            ...
            if (out.isEnabled(SerializerFeature.WriteClassName)) {
                if (object.getClass() != fieldType) {
                    out.write('{');
                    out.writeFieldName(com.kangaroo.internal.fastjson.JSON.DEFAULT_TYPE_KEY);
        ...
        } else if (object instanceof com.kangaroo.internal.fastjson.JSONStreamAware) {
            com.kangaroo.internal.fastjson.JSONStreamAware aware = (com.kangaroo.internal.fastjson.JSONStreamAware) object;
            ...
            throw new com.kangaroo.internal.fastjson.JSONException("not support class : " + objClass);
        }
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type clazz, Object fieldName) {
            ...
            for (;;) {
                ...
                if (key.equals("address")) {
                    ...
                    if (lexer.token() != JSONToken.LITERAL_INT) {
                        throw new com.kangaroo.internal.fastjson.JSONException("port is not int");
                    }
                    port = lexer.intValue();
                    lexer.nextToken();
                } else {
        ...
        if (objVal == null) {
            ...
            if (objVal instanceof com.kangaroo.internal.fastjson.JSONObject) {
                com.kangaroo.internal.fastjson.JSONObject jsonObject = (com.kangaroo.internal.fastjson.JSONObject) objVal;
            ...
            throw new com.kangaroo.internal.fastjson.JSONException("expect string");
        }
        ...
        if (clazz == URL.class) {
            try {
                ...
                throw new com.kangaroo.internal.fastjson.JSONException("create url error", e);
            }
        }
        ...
        if (clazz == Locale.class) {
            return (T) com.kangaroo.internal.fastjson.util.TypeUtils.toLocale(strVal);
        }
        ...
        if (clazz == InetAddress.class || clazz == Inet4Address.class || clazz == Inet6Address.class) {
            try {
                ...
                throw new com.kangaroo.internal.fastjson.JSONException("deserialize inet adress error", e);
            }
        }

        if (clazz == File.class) {
            if (strVal.indexOf("..") >= 0 && !FILE_RELATIVE_PATH_SUPPORT) {
                throw new com.kangaroo.internal.fastjson.JSONException("file relative path not support.");
            }
        ...
        if (clazz == Class.class) {
            return (T) com.kangaroo.internal.fastjson.util.TypeUtils.loadClass(strVal, parser.getConfig().getDefaultClassLoader());
        }
        ...
        if (clazz == com.kangaroo.internal.fastjson.JSONPath.class) {
            ...
            if (className.equals("java.nio.file.Path")) {
                try {
                    if (method_paths_get == null && !method_paths_get_error) {
                        Class<?> paths = com.kangaroo.internal.fastjson.util.TypeUtils.loadClass("java.nio.file.Paths");
                    ...
                    throw new com.kangaroo.internal.fastjson.JSONException("Path deserialize erorr");
                } catch (NoSuchMethodException ex) {
                    method_paths_get_error = true;
                } catch (IllegalAccessException ex) {
                    throw new com.kangaroo.internal.fastjson.JSONException("Path deserialize erorr", ex);
                } catch (InvocationTargetException ex) {
                    throw new com.kangaroo.internal.fastjson.JSONException("Path deserialize erorr", ex);
                }
            }

            throw new com.kangaroo.internal.fastjson.JSONException("MiscCodec not support " + className);
        }

        throw new com.kangaroo.internal.fastjson.JSONException("MiscCodec not support " + clazz.toString());
    }
