...
import com.kangaroo.internal.fastjson.asm.ClassReader;
import com.kangaroo.internal.fastjson.asm.TypeCollector;
...
public class ASMUtils {
    ...
    public static String[] lookupParameterNames(AccessibleObject methodOrCtor) {
        ...
        try {
            ...
            com.kangaroo.internal.fastjson.util.IOUtils.close(is);
        }
    }
}
