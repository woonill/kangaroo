...
import com.kangaroo.internal.fastjson.annotation.JSONCreator;
import com.kangaroo.internal.fastjson.annotation.JSONField;
import com.kangaroo.internal.fastjson.annotation.JSONPOJOBuilder;
...
public class JavaBeanInfo {
    ...
    public final com.kangaroo.internal.fastjson.util.FieldInfo[] fields;
    public final com.kangaroo.internal.fastjson.util.FieldInfo[] sortedFields;
    ...
    public JavaBeanInfo(Class<?> clazz, //
                        ...
                        Method buildMethod, //
                        JSONType jsonType, //
                        List<com.kangaroo.internal.fastjson.util.FieldInfo> fieldList) {
        this.clazz = clazz;
        this.builderClass = builderClass;
        this.defaultConstructor = defaultConstructor;
        this.creatorConstructor = creatorConstructor;
        this.factoryMethod = factoryMethod;
        this.parserFeatures = com.kangaroo.internal.fastjson.util.TypeUtils.getParserFeatures(clazz);
        ...
        fields = new com.kangaroo.internal.fastjson.util.FieldInfo[fieldList.size()];
        fieldList.toArray(fields);

        com.kangaroo.internal.fastjson.util.FieldInfo[] sortedFields = new com.kangaroo.internal.fastjson.util.FieldInfo[fields.length];
        if (orders != null) {
            LinkedHashMap<String, com.kangaroo.internal.fastjson.util.FieldInfo> map = new LinkedHashMap<String, com.kangaroo.internal.fastjson.util.FieldInfo>(fieldList.size());
            for (com.kangaroo.internal.fastjson.util.FieldInfo field : fields) {
                map.put(field.name, field);
            }
            int i = 0;
            for (String item : orders) {
                com.kangaroo.internal.fastjson.util.FieldInfo field = map.get(item);
                if (field != null) {
                    sortedFields[i++] = field;
                    map.remove(item);
                }
            }
            for (com.kangaroo.internal.fastjson.util.FieldInfo field : map.values()) {
                sortedFields[i++] = field;
            }
        } else {
        ...
        if (creatorConstructor != null) {
            ...
            boolean kotlin = com.kangaroo.internal.fastjson.util.TypeUtils.isKotlin(clazz);
            if (kotlin) {
                this.creatorConstructorParameters = com.kangaroo.internal.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                ...
                if (!match) {
                    this.creatorConstructorParameters = com.kangaroo.internal.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                }
            }
        }
    }

    private static com.kangaroo.internal.fastjson.util.FieldInfo getField(List<com.kangaroo.internal.fastjson.util.FieldInfo> fieldList, String propertyName) {
        for (com.kangaroo.internal.fastjson.util.FieldInfo item : fieldList) {
    ...
    static boolean add(List<com.kangaroo.internal.fastjson.util.FieldInfo> fieldList, com.kangaroo.internal.fastjson.util.FieldInfo field) {
        for (int i = fieldList.size() - 1; i >= 0; --i) {
            com.kangaroo.internal.fastjson.util.FieldInfo item = fieldList.get(i);
    ...
    public static JavaBeanInfo build(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy) {
        return build(clazz, type, propertyNamingStrategy, false, com.kangaroo.internal.fastjson.util.TypeUtils.compatibleWithJavaBean);
    }
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        List<com.kangaroo.internal.fastjson.util.FieldInfo> fieldList = new ArrayList<com.kangaroo.internal.fastjson.util.FieldInfo>();
        ...
        if ((defaultConstructor == null && builderClass == null) || isInterfaceOrAbstract) {
            ...
            if (creatorConstructor != null && !isInterfaceOrAbstract) { // 基于标记 JSONCreator 注解的构造方法
                com.kangaroo.internal.fastjson.util.TypeUtils.setAccessible(creatorConstructor);
                ...
                if (types.length > 0) {
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        if (fieldAnnotation != null) {
                            field = com.kangaroo.internal.fastjson.util.TypeUtils.getField(clazz, fieldAnnotation.name(), declaredFields);
                            ordinal = fieldAnnotation.ordinal();
                            serialzeFeatures = com.kangaroo.internal.fastjson.serializer.SerializerFeature.of(fieldAnnotation.serialzeFeatures());
                        ...
                        if (fieldName == null || fieldName.length() == 0) {
                            if (lookupParameterNames == null) {
                                lookupParameterNames = com.kangaroo.internal.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                            }
                            fieldName = lookupParameterNames[i];
                        }

                        com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo = new com.kangaroo.internal.fastjson.util.FieldInfo(fieldName, clazz, fieldClass, fieldType, field,
                ...
                com.kangaroo.internal.fastjson.util.TypeUtils.setAccessible(factoryMethod);
                ...
                if (types.length > 0) {
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        Field field = com.kangaroo.internal.fastjson.util.TypeUtils.getField(clazz, fieldAnnotation.name(), declaredFields);
                        final int ordinal = fieldAnnotation.ordinal();
                        final int serialzeFeatures = com.kangaroo.internal.fastjson.serializer.SerializerFeature.of(fieldAnnotation.serialzeFeatures());
                        final int parserFeatures = Feature.of(fieldAnnotation.parseFeatures());
                        com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo = new com.kangaroo.internal.fastjson.util.FieldInfo(fieldAnnotation.name(), clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
                ...
                if (kotlin && constructors.length > 0) {
                    paramNames = com.kangaroo.internal.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                    creatorConstructor = com.kangaroo.internal.fastjson.util.TypeUtils.getKoltinConstructor(constructors);
                    com.kangaroo.internal.fastjson.util.TypeUtils.setAccessible(creatorConstructor);
                } else {
                    ...
                    for (Constructor constructor : constructors) {
                        ...
                        if (className.equals("org.springframework.security.web.authentication.WebAuthenticationDetails")) {
                            if (parameterTypes.length == 2 && parameterTypes[0] == String.class && parameterTypes[1] == String.class) {
                                ...
                                paramNames = com.kangaroo.internal.fastjson.util.ASMUtils.lookupParameterNames(constructor);
                                break;
                            }
                        }
                        ...
                        String[] lookupParameterNames = com.kangaroo.internal.fastjson.util.ASMUtils.lookupParameterNames(constructor);
                ...
                if (paramNames != null
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        Class<?> fieldClass = types[i];
                        Type fieldType = creatorConstructor.getGenericParameterTypes()[i];
                        Field field = com.kangaroo.internal.fastjson.util.TypeUtils.getField(clazz, paramName, declaredFields);
                        if (field != null) {
                            if (fieldAnnotation == null) {
                        ...
                        com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo = new com.kangaroo.internal.fastjson.util.FieldInfo(paramName, clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
        ...
        if (defaultConstructor != null) {
            com.kangaroo.internal.fastjson.util.TypeUtils.setAccessible(defaultConstructor);
        }
        ...
        if (builderClass != null) {
            ...
            for (Method method : builderClass.getMethods()) {
                ...
                if (annotation == null) {
                    annotation = com.kangaroo.internal.fastjson.util.TypeUtils.getSuperMethodAnnotation(clazz, method);
                }
                ...
                if (annotation != null) {
                    ...
                    serialzeFeatures = com.kangaroo.internal.fastjson.serializer.SerializerFeature.of(annotation.serialzeFeatures());
                    parserFeatures = Feature.of(annotation.parseFeatures());

                    if (annotation.name().length() != 0) {
                        String propertyName = annotation.name();
                        add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo(propertyName, method, null, clazz, type, ordinal, serialzeFeatures, parserFeatures,
            ...
            if (builderClass != null) {
                ...
                com.kangaroo.internal.fastjson.util.TypeUtils.setAccessible(buildMethod);
            }
        }
        ...
        for (Method method : methods) { //
            ...
            if (annotation != null
                ...
                add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo("", method, null, clazz, type, ordinal,
            ...
            if (Character.isUpperCase(c3) //
                ...
                if (com.kangaroo.internal.fastjson.util.TypeUtils.compatibleWithJavaBean) {
                    propertyName = com.kangaroo.internal.fastjson.util.TypeUtils.decapitalize(methodName.substring(3));
                } else {
            ...
            Field field = com.kangaroo.internal.fastjson.util.TypeUtils.getField(clazz, propertyName, declaredFields);
            if (field == null && types[0] == boolean.class) {
                String isFieldName = "is" + Character.toUpperCase(propertyName.charAt(0)) + propertyName.substring(1);
                field = com.kangaroo.internal.fastjson.util.TypeUtils.getField(clazz, isFieldName, declaredFields);
            }
            ...
            if (field != null) {
                ...
                if (fieldAnnotation != null) {
                    ...
                    if (fieldAnnotation.name().length() != 0) {
                        ...
                        add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo(propertyName, method, field, clazz, type, ordinal,
            ...
            add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo(propertyName, method, field, clazz, type, ordinal, serialzeFeatures, parserFeatures,
        ...
        for (Method method : clazz.getMethods()) { // getter methods
            ...
            if (builderClass == null && methodName.startsWith("get") && Character.isUpperCase(methodName.charAt(3))) {
                ...
                if (Collection.class.isAssignableFrom(method.getReturnType()) //
                    ...
                    com.kangaroo.internal.fastjson.util.FieldInfo fieldInfo = getField(fieldList, propertyName);
                    if (fieldInfo != null) {
                        continue;
                    }

                    add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo(propertyName, method, null, clazz, type, 0, 0, 0, annotation, null, null));
                }
            }
        }
    ...
    private static void computeFields(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy, List<com.kangaroo.internal.fastjson.util.FieldInfo> fieldList, Field[] fields) {
        for (Field field : fields) { // public static fields
            ...
            add(fieldList, new com.kangaroo.internal.fastjson.util.FieldInfo(propertyName, null, field, clazz, type, ordinal, serialzeFeatures, parserFeatures, null,
    ...
    public static Class<?> getBuilderClass(Class<?> clazz, JSONType type) {
        if (clazz != null && clazz.getName().equals("org.springframework.security.web.savedrequest.DefaultSavedRequest")) {
            return com.kangaroo.internal.fastjson.util.TypeUtils.loadClass("org.springframework.security.web.savedrequest.DefaultSavedRequest$Builder");
        }
