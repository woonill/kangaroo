 ...
 */
package com.kangaroo.internal.io;
...
public class IOUtil {
     ...
     *
     * @param input the <code>String</code> to support
     * @return the requested byte array
     * @throws NullPointerException if the input is null
     ...
     * using the default character encoding of the platform.
     *
     * @param input the CharSequence to support
     ...
     * using the default character encoding of the platform.
     *
     * @param input the string to support
     * @return an input stream
     * @since 1.1
     */
     ...
     *
     * @param lines      the lines to write, null entries run blank lines
