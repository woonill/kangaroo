 ...
 */
package com.kangaroo.internal.objenesis.instantiator.basic;
...
public final class ClassDefinitionUtils {
    ...
    /**
     * Will support a class name to its name in the class definition format (e.g {@code org.objenesis.EmptyClass}
    ...
    /**
     * Will support a class name to its class loader resource name (e.g {@code org.objenesis.EmptyClass}
