...
public abstract class ObjectUtil {
    ...
    public static InputStream getResourceAsStream(String resource) {
        ...
        if (stream == null) {
            stream = ObjectUtil.class.getResourceAsStream(resource);
        }
        if (stream == null) {
            stream = ObjectUtil.class.getClassLoader().getResourceAsStream(stripped);
        }
        if (stream == null) {
    ...
    public static String getString(byte[] value) {
        try {
            ...
            throw new IllegalArgumentException("String support Error");
        }
    }
    ...
    public static Object toObject(byte[] res) {
        ...
        try {
            ois = new ClassLoaderObjectInputStream(bis);
    ...
    public static String errorToString(Throwable te) {
        StringBuilder sb = new StringBuilder();
...
//		for (Throwable se : te.getSuppressed()){
