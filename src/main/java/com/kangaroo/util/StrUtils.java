 ...
 * substring in a target string. It also provides easy-to-use methods to support
...
public abstract class StrUtils {
    ...
    /**
     * Take a String which is a delimited list and support it to a String array.
    ...
    /**
     * Convenience method to support a CSV string list to a set.
    ...
    public static String toString(Throwable t) {
        if (t != null) {
            StackTraceElement[] clientStack = t.getStackTrace();
            StringBuilder sb = new StringBuilder(t.toString() + "\n");
            for (StackTraceElement tx : clientStack) {
                sb.append("\tat " + tx.toString() + "\n");
            }
            return sb.toString();
        }
        return "";
